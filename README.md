...
(async () => {
  const input = {
    ...
    endDate: '2023-11-20',
    endTime: 13674040.58155191,
    networkBrand: 'CELITECH',
    startDate: '2023-11-01',
    startTime: 86621044.288587,
  };
...
(async () => {
  const result = await sdk.purchases.listPurchases({
    ...
    afterCursor:
      'Y3JlYXRlZEF0OjE1OTk0OTMwOTgsZGVzdGluYXRpb246QVVTLG1pbkRheXM6MCxkYXRhTGltaXRJbkJ5dGVzOjUzNjg3MDkxMjA',
    limit: 20,
    after: 80882367.35869989,
    before: -96759484.19826117,
  });
  console.log(result);
})();
...
(async () => {
  const input = {
    ...
    email: 'example@domain.com',
    endDate: '2023-11-20',
    endTime: 62448974.81190997,
    iccid: '1111222233334444555',
    startDate: '2023-11-01',
    startTime: -5339841.82404308,
  };
...
(async () => {
  const input = {
    endDate: '2023-11-20',
    endTime: -78120956.40562595,
    purchaseId: 'ae471106-c8b4-42cf-b83a-b061291f2922',
    startDate: '2023-11-01',
    startTime: -73386216.9320163,
  };
