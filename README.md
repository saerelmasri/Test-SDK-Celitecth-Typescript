...
(async () => {
  const input = {
    ...
    endDate: '2023-11-20',
    endTime: 40227086.279108435,
    networkBrand: 'CELITECH',
    startDate: '2023-11-01',
    startTime: 64901828.05188903,
  };
...
(async () => {
  const result = await sdk.purchases.listPurchases({
    ...
    afterCursor:
      'Y3JlYXRlZEF0OjE1OTk0OTMwOTgsZGVzdGluYXRpb246QVVTLG1pbkRheXM6MCxkYXRhTGltaXRJbkJ5dGVzOjUzNjg3MDkxMjA',
    limit: 20,
    after: 27433664.14856991,
    before: -70482165.04327774,
  });
  console.log(result);
})();
...
(async () => {
  const input = {
    ...
    email: 'example@domain.com',
    endDate: '2023-11-20',
    endTime: -45462892.01232851,
    iccid: '1111222233334444555',
    startDate: '2023-11-01',
    startTime: 55580234.75414169,
  };
...
(async () => {
  const input = {
    endDate: '2023-11-20',
    endTime: -14492016.01990731,
    purchaseId: 'ae471106-c8b4-42cf-b83a-b061291f2922',
    startDate: '2023-11-01',
    startTime: -19283812.227712184,
  };
