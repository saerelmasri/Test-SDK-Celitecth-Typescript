...
(async () => {
  const input = {
    ...
    endDate: '2023-11-20',
    endTime: 39793882.64036521,
    networkBrand: 'CELITECH',
    startDate: '2023-11-01',
    startTime: 83497502.31458414,
  };
...
(async () => {
  const result = await sdk.purchases.listPurchases({
    ...
    afterCursor:
      'Y3JlYXRlZEF0OjE1OTk0OTMwOTgsZGVzdGluYXRpb246QVVTLG1pbkRheXM6MCxkYXRhTGltaXRJbkJ5dGVzOjUzNjg3MDkxMjA',
    limit: 20,
    after: 92444499.98216036,
    before: 2914883.859234065,
  });
  console.log(result);
})();
...
(async () => {
  const input = {
    ...
    email: 'example@domain.com',
    endDate: '2023-11-20',
    endTime: 91604213.68867698,
    iccid: '1111222233334444555',
    startDate: '2023-11-01',
    startTime: 88361660.58856198,
  };
...
(async () => {
  const input = {
    endDate: '2023-11-20',
    endTime: -16523408.70335421,
    purchaseId: 'ae471106-c8b4-42cf-b83a-b061291f2922',
    startDate: '2023-11-01',
    startTime: -26978374.67411706,
  };
